...
#define ENCODING_MODE_JPEG	0x01
#define ENCODING_MODE_H264	0x02
...
struct frame_packet {
	...
	uint64_t timestamp;			// presentation timestamp of this frame
	uint64_t flag;				// flags on the sender side
